...
export const Terminal = ({
  ...
  const content = (
    <div
      ref={containerRef}
      className={cn(
        'border-border z-0 h-full max-h-100 w-full max-w-lg rounded-xl border',
        className,
      )}
    >
      <div className="border-border flex flex-col gap-y-2 border-b dark:border-white/20 p-4">
